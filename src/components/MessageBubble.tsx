...
export function MessageBubble({
  ...
  const base = "px-3 sm:px-5 py-3 sm:py-4 max-w-[90%] sm:max-w-[80%] transition-all duration-200";
  const userClasses = "ml-auto text-gray-800";
    ...
    <>
      {role === "user" ? (
        ...
        <div className="flex flex-row-reverse items-start gap-2 sm:gap-3">
          <div 
            className={`${base} ${userClasses} ${isAudio ? 'flex flex-col gap-2' : ''}`}
          >
            {isAudio && audioFile ? (
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start gap-2 sm:gap-3">
            ...
            {/* Message content */}
            <div 
              className={`${base} ${botClasses} ${isAudio ? 'flex flex-col gap-2' : ''} group relative bot-message-no-radius`}
