...
export default function HomePage({
  ...
  return (
    <div className="h-screen flex flex-col bg-white overflow-hidden">
      {/* Mobile View */}
      {!showChat ? (
        <div className="md:hidden flex flex-col bg-white overflow-y-auto" style={{ minHeight: '100vh', height: '100vh', maxHeight: '100vh' }}>
          {/* Language Selector - Mobile */}
          <div className="absolute top-[10px] right-[20px] z-50">
            <LanguageSelector />
          </div>
          {/* Main Content */}
          <main className="flex-1 flex items-start justify-start" style={{ width: '100%', boxSizing: 'border-box', marginTop: '29px', paddingLeft: '40px', paddingRight: '40px', paddingBottom: '40px' }}>
            <div className="w-full" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', marginTop: '40px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', width: '100%', marginTop: '18px' }}>
                  <h1
                    style={{ 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', width: '100%', marginTop: '45px', marginBottom: '25px' }}>
              ...
              {/* Share link section */}
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', padding: '0px', width: '100%' }}>
                {/* label-text */}
                ...
                >
                  {/* Cont */}
                  <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', padding: '0px 15px', width: '100%', height: '40px' }}>
                    {/* left */}
                    ...
                    {/* Right */}
                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center', padding: '0px', gap: '5px', width: '75px', height: '40px', flex: 'none' }}>
                      {/* button-small */}
                      <button
