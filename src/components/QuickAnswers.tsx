...
export default function QuickAnswers({ onAnswerClick, disabled = false, isClosing = false }: QuickAnswersProps) {
  return (
    <div className={`px-6 py-4 bg-white border-t border-brand-200 quick-answers-container ${isClosing ? 'quick-answers-closing' : ''}`}>
      <div className="text-sm font-medium text-gray-600 mb-3">Quick Answers 💡 </div>
